...
def main():
    ...
    parser.add_argument('-p', '--all_predict', type=bool, required=True, help='Use all data for prediction.')
    ...
    variables.init_ref(args.reference_genome)
    ...
    train_pairs, train_labels, train_kmers, val_pairs, val_labels, val_kmers, \
        test_pairs, test_labels, test_kmers = load_pairs(args.positive_loops, args.negative_loops, variables.hg19)
